...
class NewLessonNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ...
                    ->line("A new lesson has been added to your class" . $this->enrolled_student->class . "!")
                    ->action('View Class lesson', url("/classes/single/" . $this->enrolled_student->classid . "?tab=lessons"))
    ...
    public function toDatabase(object $notifiable)
    {
        return new DatabaseMessage([
            'message' => 'A new lesson has been added to your class' . $this->enrolled_student->class . "!",
