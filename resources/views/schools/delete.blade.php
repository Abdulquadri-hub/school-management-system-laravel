  ...
  <div class="row">
    ...
    <div class="card">
        ...
        <form method="post" class="row g-3">
            ...
            <div class="col-12">
                <input type="text" name="school" readonly value="{{old('school',$row->school)}}" class="form-control" id="" placeholder="School Name">
            </div>  
            ...
            <div class="col-12">
                ...
                <button onclick="trash(event)" class="btn btn-primary float-end btn-sm" type="submit">Trash</button>
            </div>
            @else
...
<script>
    ...
    // use the confirm event
      if (!confirm("Are sure you want to delete this school ?")) {
      e.preventDefault();
      return;
    }   
  }
