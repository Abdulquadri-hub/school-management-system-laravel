<div class="m-auto p-4" style="max-width: 400px;">
        <form method="post" class="row g-3">
            ...
            <div class="col-12">
                <input type="text" name="student" value="{{old('student')}}" class="form-control" id="" placeholder="Search for student">
            </div>  

            <div class="col-12">
                <a href="{{route('class.single', ['id'=> $row->id, 'tab' => 'enrolled-students'])}}">
